...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_dixonwille_wlog_v3",
        importpath = "github.com/dixonwille/wlog/v3",
        sum = "h1:ViTSsNNndHlKW5S89x5O0KSTpTT9zdPqrkA/TZYY8+s=",
        version = "v3.0.1",
    )
    go_repository(
        name = "com_github_dixonwille_wmenu_v5",
        importpath = "github.com/dixonwille/wmenu/v5",
        sum = "h1:sKBHDoQ945NRvK0Eitd0kHDYHl1IYOSr1sdCK9c+Qr0=",
        version = "v5.1.0",
    )
    go_repository(
